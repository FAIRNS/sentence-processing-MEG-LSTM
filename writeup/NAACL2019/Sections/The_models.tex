...
To inspect the internal dynamics of these models, we use additional linear models to extract information from the hidden state of trained language models \cite[see, e.g.\ ]{Adi:etal:2017,Hupkes:etal:2017} \dieuwke{Or something like this. @yair perhaps we have also some neuroscience ref?}
