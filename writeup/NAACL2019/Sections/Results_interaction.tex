...
\begin{figure*}[t]
    ...
    \end{subfigure}
\caption{Connections to syntax unit \unit{2}{500} and LR-number units \unit{2}{126} and \unit{2}{338}. \marco{ put more extended caption (possibly moving stuff from text).}}
