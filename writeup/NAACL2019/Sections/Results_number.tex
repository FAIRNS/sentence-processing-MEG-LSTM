...
(right column -- `Full'). We first confirmed the results of \newcite{Gulordava:etal:2018} for the Linzen NA-task. For the other NA-tasks, results show that some tasks and
