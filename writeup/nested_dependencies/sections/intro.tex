...
\item Neural Language Models as psycholinguistic subjects - revived interest in  NLMs as computational models of language processing. Ideally, NLMs would provide us with quantitative and predictive models for both behavior, coarse neural mechanisms and possibly language acquisition. \dieuwke{Perhaps it is better to already here refer introduce them as \emph{hypothesis generators}, this way we do not get into trouble when we have only one model later?}
...
\item Our goal here is two-fold:
  ...
  this mechanism to a different language, as well as extending them to a different agreement phenomenon, confirming it is no fluke. \dieuwke{I would also stay away from the fluke thing, since we are not presenting conclusions about a language model. Rather maybe say something like: we replicate earlier results to a morphologically more rich language and extend our tests withmore agreement phenomena to better understand, or smth like that.}
