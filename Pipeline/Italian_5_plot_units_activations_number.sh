...
NUM_STIMULI=4000
for NATASK in 'nounpp' #'embedding_mental_SR' 'objrel_that_V1' 
    #'objrel_that_V2'
    # 'subjrel_that_V1' 'subjrel_that_V2';
do
    for UNIT in '814'
...
#    for UNIT in '1220' '1126' '650' '0' '610' '623' '680' '1091' '814' '1118' '859' '1225';
    #for UNIT in '204' '238' '244' '650' '690' '708' '987' '1012' '1064' '1091' '1167' '1218';
     ...
     do
         eval 'python3 ../Code/LSTM/model-analysis/plot_units_activations.py -sentences ../Data/Stimuli/Italian_'$NATASK'_'$NUM_STIMULI'.text -meta ../Data/Stimuli/Italian_'$NATASK'_'$NUM_STIMULI'.info -activations ../Data/LSTM/activations/Italian/'$NATASK'.pkl -o ../Figures/Italian_'$NATASK'_'$UNIT'.png -c '$NATASK' -g 1 r \- 6 '$UNIT' cell number_1 singular number_2 singular -g 1 r "\--" 6 '$UNIT' cell number_1 singular number_2 plural -g 1 b \- 6 '$UNIT' cell number_1 plural number_2 plural -g 1 b "\--" 6 '$UNIT' cell number_1 plural number_2 singular -y "\$C\_t\$" --no-legend --figheight 4 --figwidth 16'
