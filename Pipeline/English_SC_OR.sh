...
# GENERATE STIMULI
python ../Code/Stimuli/English_Yair/NA_tasks_generator.py --natask SC_OR -seed 1 -n 256 > ../Data/Stimuli/English_SC_OR.txt

# TRANSFORM TO LINZEN FORMAT
python3 ../Code/Stimuli/generate_info_from_raw_txt.py -i ../Data/Stimuli/English_SC_OR.txt -o ../Data/Stimuli/English_SC_OR_V1 -p number_1 3 -p number_2 5 -p number_3 7 -p verb_1_wrong 8 -p verb_2_wrong 9 -p verb_3_wrong 10 --correct-word-position 10 --wrong-word-label verb_1_wrong

python3 ../Code/Stimuli/generate_info_from_raw_txt.py -i ../Data/Stimuli/English_SC_OR.txt -o ../Data/Stimuli/English_SC_OR_V2 -p number_1 3 -p number_2 5 -p number_3 7 -p verb_1_wrong 8 -p verb_2_wrong 9 -p verb_3_wrong 10 --correct-word-position 9 --wrong-word-label verb_2_wrong

python3 ../Code/Stimuli/generate_info_from_raw_txt.py -i ../Data/Stimuli/English_SC_OR.txt -o ../Data/Stimuli/English_SC_OR_V3 -p number_1 3 -p number_2 5 -p number_3 7 -p verb_1_wrong 8 -p verb_2_wrong 9 -p verb_3_wrong 10 --correct-word-position 8 --wrong-word-label verb_3_wrong

# EXTRACT PREDICTIONS
python3 ../Code/LSTM/model-analysis/extract_predictions.py ../Data/LSTM/models/english/hidden650_batch128_dropout0.2_lr20.0.pt -i ../Data/Stimuli/English_SC_OR_V1 -v ../Data/LSTM/models/english/english_vocab.txt -o ../Output/English_SC_OR_V1 --eos-separator "<eos>" --format pkl --lang en --uppercase-first-word

python3 ../Code/LSTM/model-analysis/extract_predictions.py ../Data/LSTM/models/english/hidden650_batch128_dropout0.2_lr20.0.pt -i ../Data/Stimuli/English_SC_OR_V2 -v ../Data/LSTM/models/english/english_vocab.txt -o ../Output/English_SC_OR_V2 --eos-separator "<eos>" --format pkl --lang en --uppercase-first-word

python3 ../Code/LSTM/model-analysis/extract_predictions.py ../Data/LSTM/models/english/hidden650_batch128_dropout0.2_lr20.0.pt -i ../Data/Stimuli/English_SC_OR_V3 -v ../Data/LSTM/models/english/english_vocab.txt -o ../Output/English_SC_OR_V3 --eos-separator "<eos>" --format pkl --lang en --uppercase-first-word
