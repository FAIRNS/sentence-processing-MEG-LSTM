...
i=i+1;r{i}.wt=1; r{i}.match='_VT_V_P0';r{i}.subst = {'attack'};r{i}.addi={{'$ANIMATE_SUB','$ANIMATE_OBJ','$SAD'}};
i=i+1;r{i}.wt=1; r{i}.match='_VT_V_P0';r{i}.subst = {'fight'};r{i}.addi={{'$ANIMATE_SUB','$ANIMATE_OBJ','$SAD'}};
i=i+1;r{i}.wt=1; r{i}.match='_VT_V_P0';r{i}.subst = {'meet'};r{i}.addi={{'$ANIMATE_SUB','$ANIMATE_OBJ','$HAPPY'}};
i=i+1;r{i}.wt=1; r{i}.match='_VT_V_P0';r{i}.subst = {'greet'};r{i}.addi={{'$ANIMATE_SUB','$ANIMATE_OBJ','$HAPPY'}};
...
i=i+1;r{i}.wt=1; r{i}.match='_VI_V_P0';r{i}.subst = {'laugh'};r{i}.addi={{'$ANIMATE_SUB','$UNERGATIVE','$HAPPY'}}; 
i=i+1;r{i}.wt=1; r{i}.match='_VI_V_P0';r{i}.subst = {'cry'};r{i}.addi={{'$ANIMATE_SUB','$UNERGATIVE','$SAD'}};
i=i+1;r{i}.wt=1; r{i}.match='_VI_V_P0';r{i}.subst = {'smile'};r{i}.addi={{'$ANIMATE_SUB','$UNERGATIVE','$HAPPY'}};
i=i+1;r{i}.wt=1; r{i}.match='_VI_V_P0';r{i}.subst = {'frown'};r{i}.addi={{'$ANIMATE_SUB','$UNERGATIVE','$SAD'}};
...
i=i+1;r{i}.wt=1; r{i}.match='_N_P0';r{i}.subst = {'rock'};r{i}.addi={{'$SMALL_NOUN','$INANIMATE'}};   
