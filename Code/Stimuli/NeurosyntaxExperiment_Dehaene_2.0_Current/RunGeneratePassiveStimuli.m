...
try
    NeuroSyntaxSetPaths
    savedir=[ActiveStuffPath 'DehaeneLanguageProject/Neurosyntax2.0_Package_Passive/Neurosyntax2.0_Passive_Presentation/' subjectname];
catch
    savedir=[pwd filesep subjectname];
