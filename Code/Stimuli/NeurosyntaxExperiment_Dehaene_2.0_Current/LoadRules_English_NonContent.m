...
i=i+1;r{i}.wt=1; r{i}.match='_N_P1';r{i}.subst = {'_N_L_ADJUNCT','_N_P1_B'}; %16
i=i+1;r{i}.wt=2; r{i}.match='_N_L_ADJUNCT';r{i}.subst = {'_A_P2'}; %17
...
i=i+1;r{i}.wt=1; r{i}.match='_N_P1_B';r{i}.subst = {'_N_P0'};  r{i}.lab='PPLoc2_Off';  %19           %turn this rule OFF if chossing PPLoc2 
i=i+1;r{i}.wt=1; r{i}.match='_N_P1_B';r{i}.subst = {'_N_P0','_N_COMP'}; r{i}.lab='PPLoc2_On'; %20           %turn this rule ON if chossing PPLoc2 
...
i=i+1;r{i}.wt=1; r{i}.match='_T_P0';r{i}.subst = {'#future'};   r{i}.addi={{'$AUX_YES'}};
...
i=i+1;r{i}.wt=1; r{i}.match='_T_P0';r{i}.subst = {'#past'};     r{i}.addi={{'$AUX_NO'}};
