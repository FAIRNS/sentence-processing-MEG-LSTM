...
i=i+1;r{i}.wt=1; r{i}.match='_VT_V_P0';r{i}.subst = {'frapper'};r{i}.addi={{'$ANIMATE_SUB','$ANIMATE_OBJ','$SAD_VERB'}};
i=i+1;r{i}.wt=1; r{i}.match='_VT_V_P0';r{i}.subst = {'tuer'};r{i}.addi={{'$ANIMATE_SUB','$ANIMATE_OBJ','$SAD_VERB'}};
i=i+1;r{i}.wt=1; r{i}.match='_VT_V_P0';r{i}.subst = {'embrasser'};r{i}.addi={{'$ANIMATE_SUB','$ANIMATE_OBJ','$HAPPY_VERB'}};
...
i=i+1;r{i}.wt=1; r{i}.match='_VT_V_P0';r{i}.subst = {'salir'};r{i}.addi={{'$ANIMATE_SUB','$INANIMATE_OBJ','$TYPE1'}};
i=i+1;r{i}.wt=1; r{i}.match='_VT_V_P0';r{i}.subst = {'réparer'};r{i}.addi={{'$ANIMATE_SUB','$INANIMATE_OBJ','$TYPE2'}};
...
i=i+1;r{i}.wt=1; r{i}.match='_VT_V_P0';r{i}.subst = {'réjouir'};r{i}.addi={{'$INANIMATE_SUB','$ANIMATE_OBJ','$HAPPY_VERB'}};
...
i=i+1;r{i}.wt=1; r{i}.match='_VT_V_P0';r{i}.subst = {'cogner'};r{i}.addi={{'$INANIMATE_SUB','$INANIMATE_OBJ'}};
...
i=i+1;r{i}.wt=1; r{i}.match='_VI_V_P0';r{i}.subst = {'pleurer'};r{i}.addi={{'$ANIMATE_SUB','$UNERGATIVE','$SAD_VERB'}};
i=i+1;r{i}.wt=1; r{i}.match='_VI_V_P0';r{i}.subst = {'sourire'};r{i}.addi={{'$ANIMATE_SUB','$UNERGATIVE','$HAPPY_VERB'}};
i=i+1;r{i}.wt=1; r{i}.match='_VI_V_P0';r{i}.subst = {'gémir'};r{i}.addi={{'$ANIMATE_SUB','$UNERGATIVE','$SAD_VERB'}};
...
i=i+1;r{i}.wt=1; r{i}.match='_VI_V_P0';r{i}.subst = {'surgir'};r{i}.addi={{'$ANIMATE_SUB','$UNACCUSATIVE','$COME'}};     
i=i+1;r{i}.wt=1; r{i}.match='_VI_V_P0';r{i}.subst = {'sortir'};r{i}.addi={{'$ANIMATE_SUB','$UNACCUSATIVE','$GO'}};
...
i=i+1;r{i}.wt=1; r{i}.match='_VI_V_P0';r{i}.subst = {'surgir'};r{i}.addi={{'$INANIMATE_SUB','$UNACCUSATIVE','$COME'}};
...
i=i+1;r{i}.wt=1; r{i}.match='_N_P0';r{i}.subst = {'vélo'};r{i}.addi={{'$MASC','$SMALL_NOUN','$INANIMATE'}};   
...
i=i+1;r{i}.wt=1; r{i}.match='_EMOTION_A_P0';r{i}.subst = {'ravi'};r{i}.addi={{'$EMOTION','$HAPPY'}};  
...
i=i+1;r{i}.wt=1; r{i}.match='_EMOTION_A_P0';r{i}.subst = {'abattu'};r{i}.addi={{'$EMOTION','$SAD'}};
i=i+1;r{i}.wt=1; r{i}.match='_EMOTION_A_P0';r{i}.subst = {'morose'};r{i}.addi={{'$EMOTION','$SAD'}};     

i=i+1;r{i}.wt=1; r{i}.match='_PHYSICAL_A_P0';r{i}.subst = {'petit'};r{i}.addi={{'$PHYSICAL','$SMALL'}};  
i=i+1;r{i}.wt=1; r{i}.match='_PHYSICAL_A_P0';r{i}.subst = {'mince'};r{i}.addi={{'$PHYSICAL','$SMALL'}};
