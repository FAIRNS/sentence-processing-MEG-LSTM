...
def  generate_NP_VP_transition_variation( sentence, NP_end_counter, VP_begin_counter ):
    ...
    NP_end_types = ['noun', 'adj']#, 'pronoun', 'proper_noun'] # here we want only relative clause sentences
...
## Incorporate relative clauses, added the 26th of May 2018 -- modified the 5th of Jun 2018
...
def get_relative_clause_qui( sentence, sent_info ):
    ...
    proper_names = ['Jean', 'Pierre', 'Paul', 'Jean-Pierre', 'Jean-Paul', 'Claire', 'Sophie', 'Cécile']
    names = ['coiffeur', 'médecin', 'boulanger', 'libraire', 'dentiste', 'facteur', 'plombier', 'curé']
    ...
    if np.random.choice([True, False]): # proper or regular noun
        ...
        if np.random.choice([True, False]):     # one or two proper names
            ...
            while name2 in sentence or name1 == name2:
