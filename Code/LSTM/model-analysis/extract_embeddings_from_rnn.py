...
parser.add_argument('--legend-labels', nargs='+', help='Two labels for the legend (e.g., "Singular", "Plural"')
...
for u, from_unit in enumerate(units):
        ...
        if not args.legend_labels:
            ...
            if u == 0:
                    label_sing, label_plur = args.legend_labels
            else:
                    label_sing = ''; label_plur = ''
...
l = plt.legend(fontsize=30, bbox_to_anchor=(1,1))
for text in l.get_texts(): # CHANGE TEXT COLOR IN LEGEND TO BLACK
    text.set_color("red")
