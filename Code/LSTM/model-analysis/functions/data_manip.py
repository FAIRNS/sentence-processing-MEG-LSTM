...
def prepare_data_for_regression(data_sentences_train, data_sentences_test, feature_type='hidden', dependent_var_name='open_nodes'):
    X_train, y_train = get_design_matrix(data_sentences_train, dependent_var_name, feature_type)
    X_test, y_test = get_design_matrix(data_sentences_test, dependent_var_name, feature_type)

    return X_train, y_train, X_test, y_test

def get_design_matrix(data_sentences, dependent_var_name, feature_type):
    '''
    ...
    X = np.hstack((X, word_freq)) # Add word freqs as another feature at the end
    ...
    elif dependent_var_name == 'embedded constituent':
        y = np.hstack(embedded_constituent)
