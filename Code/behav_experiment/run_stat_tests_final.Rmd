...
# STATS - objrel-SR: violation_position * subjects-congruency
```{r}
...
# STATS - objrel-LR: violation_position * subjects-congruency
```{r,fig.height=5, fig.width=5}
print('ANOVA-embedded')
...
# STATS: objrel (SR vs. LR) - long * violation-position * subjects-congruency (inner verb only)
```{r}
print('ANOVA')
