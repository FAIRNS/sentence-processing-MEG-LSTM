...
# STATS - Short vs Long Successive: embedded
```{r}
print('GLMM')
curr_Data = subset(Data, nested == 0 & violation_position=='inner')
glmm_with_random <- glmer(valid_answer ~ congruent_subjects * long + (1 | subject), data=curr_Data, family="binomial")
summary(glmm_with_random)
