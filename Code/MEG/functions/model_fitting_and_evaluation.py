...
# Determine the optimal regularization size (alpha) by cross-validation
# model_ridge = linear_model.RidgeCV(alphas=params.alphas, store_cv_values=True)
# model_ridge.fit(X_train, y_train)
# model_ridge.scores_val = np.mean(model_ridge.cv_values_, axis=0)
